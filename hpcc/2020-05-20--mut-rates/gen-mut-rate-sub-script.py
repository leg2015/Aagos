...
nk_config = {
    "environment_change": [
        ...
        "-CHANGE_MAGNITUDE 2 -CHANGE_FREQUENCY 1",    # 2
        "-CHANGE_MAGNITUDE 64 -CHANGE_FREQUENCY 1",   # 7
        "-CHANGE_MAGNITUDE 1024 -CHANGE_FREQUENCY 1", # 11
        "-CHANGE_MAGNITUDE 0 -CHANGE_FREQUENCY 0 -TOURNAMENT_SIZE 1"
    ]
}
...
gradient_config = {
    "environment_change": [
        ...
        "-CHANGE_MAGNITUDE 1 -CHANGE_FREQUENCY 128", # 2
        "-CHANGE_MAGNITUDE 1 -CHANGE_FREQUENCY 4",   # 7
        "-CHANGE_MAGNITUDE 4 -CHANGE_FREQUENCY 1",   # 11
        "-CHANGE_MAGNITUDE 0 -CHANGE_FREQUENCY 0 -TOURNAMENT_SIZE 1"
    ]
}

...
nk_config = {
    "environment_change": [
        ...
        "-CHANGE_MAGNITUDE 64 -CHANGE_FREQUENCY 1"   # 7
    ]
}
...
shared_config = {
    "BIT_FLIP_PROB": [
        "-APPLY_BIT_MUTS_PER_GENE 0 -BIT_FLIP_PROB 0.003 -PHASE_2_BIT_FLIP_PROB 0.003",
        "-APPLY_BIT_MUTS_PER_GENE 0 -BIT_FLIP_PROB 0.03 -PHASE_2_BIT_FLIP_PROB 0.03",
        "-APPLY_BIT_MUTS_PER_GENE 0 -BIT_FLIP_PROB 0.1 -PHASE_2_BIT_FLIP_PROB 0.1",

        "-APPLY_BIT_MUTS_PER_GENE 1 -BIT_FLIP_PROB 0.003 -PHASE_2_BIT_FLIP_PROB 0.003",
        "-APPLY_BIT_MUTS_PER_GENE 1 -BIT_FLIP_PROB 0.03 -PHASE_2_BIT_FLIP_PROB 0.03",
        "-APPLY_BIT_MUTS_PER_GENE 1 -BIT_FLIP_PROB 0.1 -PHASE_2_BIT_FLIP_PROB 0.1"
    ],

...
seed_offset = 200000
default_num_replicates = 200
job_time_request = "1:00:00"
...
shared_config = {
    ...
    "MISC": [
        "-MAX_GENS 60000 -PHASE_2_ACTIVE 0"
    ]
}
...
def main():
    ...
    nk_combos = [f"{chg} {mut} {genome} {misc} -GRADIENT_MODEL 0" for chg in nk_config["environment_change"] for mut in shared_config["BIT_FLIP_PROB"] for genome in shared_config["GENOME_SIZE"] for misc in shared_config["MISC"]]
    gradient_combos = [f"{chg} {mut} {genome} {misc} -GRADIENT_MODEL 1" for chg in gradient_config["environment_change"] for mut in shared_config["BIT_FLIP_PROB"] for genome in shared_config["GENOME_SIZE"] for misc in shared_config["MISC"]]

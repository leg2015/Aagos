...
ggplot(overlap_proportions, 
  ...
  ggsave("gene_overlap_proportions.pdf", width=10, height=20)
...
ggplot(overlap_proportions, 
  ...
  ggsave("gene_overlap_proportions_stackedbar.pdf", width=10, height=20)
```
...
ggplot(overlap_proportions_non0, 
  ...
  scale_fill_continuous(type ="viridis") +
  facet_grid(mutation_rate~chg_rate_label) + 
  ggsave("gene_overlap_proportions_non0.pdf", width=10, height=20)
...
ggplot(overlap_proportions_non0, 
  ...
  facet_grid(mutation_rate~chg_rate_label) +
  ggsave("gene_overlap_proportions_stackedbar_non0.pdf", width=10, height=20)

...
lineages <- fread("./data/filtered_lineage.csv")
...
ggplot(filter(gradient_lineages_BF003, chg_rate_label=="drift"), 
         aes(x=generation, y=coding_sites, fill=chg_rate_label, color=chg_rate_label)) +
  geom_line() +
  ggtitle("Gradient Fitness Model (drift only)") +
  theme(legend.position = "none") +
  ggsave("imgs/lineage_coding-sites_gradient_BF-0.003_full_drift-only.png", width=20, height=10)
